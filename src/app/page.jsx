          ...
          <div id="stuff" className="col-12">
            <div className="row h-100 p-0">
              <section className="col-sm-9 align-content-center">
                ...
                >
                  <div className="carousel-indicators">
                    <button
                      type="button"
                      data-bs-target="#carouselCategories"
                      data-bs-slide-to="0"
                      className="active"
                      aria-current="true"
                      aria-label="Slide 1"
                  ...
                  <div className="carousel-inner">
                    ...
                    <div id="shampoo" className="carousel-item">
                      ...
                      <div className="carousel-caption d-none d-md-block">
                        <h1 className="fs-1">
                          <strong>洗髮護髮產品</strong>
                        </h1>
                      </div>
                    </div>
                    <div id="pasta" className="carousel-item">
                      <img
                        src="images/pasta_1.jpg"
                        className="carouselImage d-block w-100"
                        alt="義大利粉"
                      />
                      <div className="carousel-caption d-none d-md-block">
              ...
              <article className="col-sm-3 fs-4">
                <div id="product-discription">對酒當歌，人生幾何？</div>
              </article>
            </div>
          </div>
